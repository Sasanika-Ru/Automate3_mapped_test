...
test.describe("New Todo", () => {
  test("should allow me to add todo items", { tag: ['@T6083'] }, async ({ page }) => {
  ...
  test("should clear text input field when an item is added", { tag: ['@T6084'] }, async ({ page }) => {
    const newTodo = page.getByPlaceholder("What needs to be done?");
  ...
  test("should append new items to the bottom of the list", { tag: ['@T6085'] }, async ({ page, browserName }) => {
